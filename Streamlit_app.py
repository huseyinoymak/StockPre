...
driver = webdriver.Chrome(service=Service(ChromeDriverManager(driver_version='125.0.6422.141').install()), options=options)
...
#    color = 'background-color: #ff3300' if val=='Negatif'  else 'background-color: #00ff00'
#    return color
